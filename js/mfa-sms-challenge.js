document.addEventListener('DOMContentLoaded', function () {
    ...
    divFather[7].classList.add('div-after-button-continue');
    const divAfterButtonContinue = divFather[7].querySelector('form > button');
    ...
    const divBottomLink = divFather[8].querySelector('form > button');
