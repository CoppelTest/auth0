document.addEventListener('DOMContentLoaded', function () {
	...
	try {
		...
		const newTxt = 'Revisa que el código tenga 6 dígitos';
		...
		if (errorSpan && errorSpan.textContent.includes('El código OTP debe tener 6 caracteres numéricos')) {
		    errorSpan.innerHTML = errorSpan.innerHTML.replace('El código OTP debe tener 6 caracteres numéricos', newTxt);
		}
		if (errorSpan) {
